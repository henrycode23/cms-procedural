<style>
nav.navbar, ul.navbar-nav.side-nav {
    background-color: #337ab6;
}
nav.navbar ul.nav > li > a, .navbar-brand {
...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    ...
    <ul class="nav navbar-right top-nav">
        <!--<li><a href="">Users Online: <?php //echo users_online(); ?></a></li>  USERS ONLINE -->
        <li><a href="">Users Online: <span class="usersonline"></span></a></li> <!-- USERS ONLINE -->
